...
const backgroundColour = computed(() => {
  ...
  return (
    classes +
    " hover:bg-gray-600 dark:hover:bg-gray-300 disabled:bg-gray-500 dark:disabled:bg-gray-500"
  );
});
...
<template>
  <button class="rounded-xl px-2 text-white dark:text-gray-700" :class="classes">
